...
predictor = dlib.shape_predictor("E:\\3d-virtual-technology\\VTuber_Unity\head_pose_estimation\\assets\\shape_predictor_68_face_landmarks.dat")

image = cv2.imread("caoke.jpg")
